  ...
  return (
    <>
       <div className="section-header">
          ...
          <p>From orgasination or accesorization</p>
      </div>
      <div className="planner-container">
        ...
        <div className="planner-info">
          ...
          <p>
            ...
            <strong>Medieval Dragon Month Planner</strong>! This high-resolution
            PNG asset combines the fierce elegance of dragons with intricate
            medieval designs to create a planner that&apos;s not only functional
            but also a work of art. Whether you&apos;re jotting down quests,
            planning battles, or just scheduling your weekly grocery run, this
            planner is your ultimate companion.
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              resolution, it&apos;s perfect for printing on any size paper, from
      ...
      <div className="planner-content">
        ...
        <div className="sticker-container">
            {stickers.map((sticker, stickerIndex) => {
               return( <div key={stickerIndex} className="sticker-card">
                    <button className="img-button" >
